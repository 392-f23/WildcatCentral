...
const MapModal = ({ isOpen, onOpenChange, latitude, longitude, locationName }) => {
    ...
    const shouldDisplayMap = coordinates && coordinates.latitude && coordinates.longitude;
                ...
                <ModalBody>
                    {shouldDisplayMap ? (
                        ...
                        <div style={{ textAlign: 'center', padding: '20px' }}>
                            <p>No location coordinates provided for this event.<br />Sorry for the inconvenience.</p>
                        </div>
                    )}
                </ModalBody>
            </ModalContent>
