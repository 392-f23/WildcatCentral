...
const JsonData = [
    {
      ...
      organization: "Platypus Affiliated Society",
      timezone: "CDT",
...
const EventPage = () => {
    ...
    const [selection, setSelection] = useState("School Org");
    ...
    return (
      ...
      <header className="App-header">
        <Banner handlePageSwitch={handlePageSwitch}/>
        <EventFilter selection={selection} toggleSelection={setSelection}/>
